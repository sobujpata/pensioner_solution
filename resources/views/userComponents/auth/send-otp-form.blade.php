    ...
    <div class="container text-center pt-md-6 registration">
        <div class="row align-items-center pt-md-5">
            <div class="log-logo col-md-7">
                ...
                ?>
                <h3 class="ex-login-header">EX-AIRMEN & MODC(AIR) RESET PASSWORD</h3>
            ...
            <div class="col-md-5 P-6">
                ...
                <div class="card px-3">
                    ...
                    <hr>
                    <button class="btn btn-info w-50 justify-center" style="margin: auto;"><a href="{{url('/userLogin')}}">Login</a></button>
                    <p class="pt-3">Or</p>
                    <button class="btn btn-success w-50" style="margin: auto;"><a href="{{url('/userRegistration')}}">Sign Up</a></button>
                    <br>
                </div>
