            ...
            <div class="modal-body">
                <div class="container-fluid m-0 p-0">
                    <div class="row m-0 p-0">
                        ...
                        <input name="id" type="text" class="d-none" id="emp_id">
                    </div>
                </div>
...
<script>
    ...
    async function FillUpUpdateForm(id,filePath){
        ...
        let res=await axios.post("/employer-admin-by-id",{id:id})
        hideLoader();
console.log(res);
        ...
        document.getElementById('emp_id').value=res.data['emp_id'];
    ...
    async function update() {
        ...
        let emp_id = document.getElementById('emp_id').value;  // ✅ Fixed variable
        ...
        showLoader();
        try {
            let res = await axios.post("/employer-circuler-update", formData, config);
            // console.log(res);
            hideLoader();
