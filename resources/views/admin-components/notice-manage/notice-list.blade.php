<div class="container-fluid">
    <div class="row">
        <h4 class="text-center">Notice Info</h4>
...
<script>
    ...
    async function getList() {
        ...
        showLoader();
        let res = await axios.get(`/notice-show`);
        hideLoader();
        // console.log(res);
        ...
        res.data.forEach(function (item, index) {
            ...
            let tr = `<tr>
                        ...
                        <td align="left" style="vertical-align:middle; width:20% !important;">${item['subject']}</td>
                        <td align="left" style="vertical-align:middle;">${item['published_on']}</td>
                        <td align="left" style="vertical-align:middle;">${item['remarks']}</td>
                        <td align="left" style="vertical-align:middle;"><img src="${item['file_url']}" alt="file" style="width:50px;"> </td>
                        <td align="left" style="vertical-align:middle;">${formattedDate}</td>

                        <td align="center" style="vertical-align:middle;">
                            <button data-path="${item['file_url']}" data-id="${item['id']}" class="btn editBtn btn-sm btn-outline-success">Edit</button>
                            <button data-path="${item['file_url']}" data-id="${item['id']}" class="btn deleteBtn btn-sm btn-outline-danger">Delete</button>
                        </td>
                    </tr>`;
            tableList.append(tr);
        });
