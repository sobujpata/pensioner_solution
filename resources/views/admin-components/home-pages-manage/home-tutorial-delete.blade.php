    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <input class="d-none" id="deletePath"/>
...
<script>
     async  function  itemDelete(){
            ...
            let vedio_url=document.getElementById('deletePath').value;
            document.getElementById('delete-modal-close').click();
            showLoader();
            let res=await axios.post("/home-page-tutorial-delete",{id:id, vedio_url:vedio_url})
            hideLoader();
