<div class="container-fluid">
    <div class="row">
        <h3 class="text-center">Home Page Help Settings</h3>
...
<script>
    ...
    async function getList() {
        ...
        showLoader();
        let res = await axios.get(`/home-page-help`);
        hideLoader();
        console.log(res);
        ...
        res.data.forEach(function (item, index) {
            ...
            let tr = `<tr>
                        ...
                        <td align="left" style="vertical-align:middle;">${item['person_type']}</td>
