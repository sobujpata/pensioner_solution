            ...
            <div class="modal-body">
                <div class="container-fluid m-0 p-0">
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-md-4 p-2">
                            <label>Role</label>
                            <select name="role" id="roleUpdate" class="form-select">
...
<script>
    ...
    async function UpdateForm(id){
        ...
        showLoader();
        let res=await axios.post("/admin-by-id",{id:id})
        hideLoader();
        ...
        document.getElementById('roleUpdate').value=res.data.data['role'];
    ...
    if (fnameUpdate.length === 0) {
        ...
        showLoader();
        try {
            let res = await axios.post("/update-admin", formData, config);
            hideLoader();
