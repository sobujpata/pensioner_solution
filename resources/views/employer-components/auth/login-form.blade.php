        ...
        <div class="container text-center pt-md-6 registration">
            <div class="row align-items-center pt-md-5">
                <div class="log-logo col-md-7">
                    <h3 class="ex-login-header text-uppercase">EMPLOYERS LOGIN</h3>
                ...
                <div class="col-md-5">
                    ...
                    <div class="card px-3 py-2">
                        ...
                        {{-- End login form --}}
                        <p style="line-height: 3rem;"><a href="{{ url('/sendOtp-employer') }}">Forgot Password</a></p>
                        <hr>
                        <button style.display='block' class="btn btn-info"><a href="{{ url('/employerRegistration') }}">Sign Up</a></button>
                        <p style="margin-top: 25px;"><a href="{{url('/userLogin')}}" class="btn btn-outline-dark">Ex Airmen & MODC (Air)  Login</a></p>
                    </div>
